...
function playerStats(playerName) {
    ...
    for (let team in game) {
        const players = game[team].plyaers;
...
const bigShoeRebounds = () => {
    ...
    for (let player in object.away.players) {
        if (object.away.players[player].shoe > shoeSize) {
            ...
            playerWithLargestShowSize = object.away.players[player];
            playerName = player;
        }
        //debugger
    }
    return {
        [playerName]: playerWithLargestShowSize,
    };
};
...
function doesLongNameStealAton() {
    ...
    for (let team in game) {
        const players = game[team].players;
        for (let player in players) {
            if (player[player].steas > maxSteals) {
